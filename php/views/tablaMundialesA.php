...
require_once "../controller/infoMundiales.php";
global $conexion;
 ?>
		...
		<tbody >
			...
			while ($mostrar=mysqli_fetch_row($result)) {
				...
				<tr >
					...
					<a href="../controller/modificarMundial.php?id=<?php echo $mostrar[0]; ?>">
					...
					<td style="text-align: center;">
					<a href="../controller/eliminarMundial.php?id=<?php echo $mostrar[0]; ?>" class="table__item__link">
